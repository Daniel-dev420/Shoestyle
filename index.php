...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($nombre !== '' && $comentario !== '') {
        ...
        $sqlInsert = "
            INSERT INTO resenas (nombre, comentario, estrellas)
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Archivo+Black&family=Bebas+Neue&family=Manrope:wght@200..800&family=Poppins:wght@300;400;500;600;700;800&display=swap"
          rel="stylesheet">
...
<section class="seccion-introduccion">
    ...
    <p>
        ...
        tacones y más, con la mejor calidad y al mejor precio.
        Navega por nuestras secciones y encuentra tu estilo.
